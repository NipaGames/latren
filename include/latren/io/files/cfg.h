...
namespace Serialization {
    ...
    public:
        ...
        static CFG::CFGObject* ParseCFG(std::stringstream&, const CFG::CFGFileTemplate&);
        bool Validate(const CFG::CFGFileTemplate&);
        bool StreamRead(std::ifstream&) override;
        bool StreamWrite(std::ofstream&) override;
...
namespace Serialization {
    ...
    bool SetCFGPointerValue(T* ptr, const CFG::ICFGField* field) {
        return SetPointerValue<T>(ptr, field, GetCFGDeserializerList());
    }
};